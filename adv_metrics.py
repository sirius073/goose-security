    ...
    while True:
        ...
        # --- 3. REPLAY ATTACK (Breaks Freshness / Availability) ---
            ...
            if len(captured_raw_frames) == 10 and not has_replayed:
                ...
                log_attack_step("Replay Attack Triggered", "Blasting older valid Packet #5 back onto the network...", "warning")
                ...
                log_attack_step("Replay Deployed", "Frame successfully injected. Let's see if the Subscriber drops it...", "danger")
