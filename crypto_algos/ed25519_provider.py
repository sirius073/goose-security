...
class Ed25519Provider(CryptoProvider):
    def __init__(self, role: str):
        """
        Loads the static keys based on the device's role.
        Publisher needs the Private Key to sign.
        Subscriber needs the Public Key to verify.
        """
        self.role = role
    ...
    def get_algo_name(self) -> str:
        return "Ed25519 Digital Signature + Nonce Tracking"
    ...
    def verify(self, payload: dict) -> tuple[bytes, dict]:
        ...
        raw_message = bytes.fromhex(payload["data"])
